...
export const yoga_sutras_samadhi_pada : YogaSutra[] = [
  {
    chapter: 1,
    verse: 1,
  ...
  },
  {
    ...
    insights_jp: "ここでパタンジャリは、ヨーガを最高度に哲学的な意味で定義します。すなわち、心のすべての変動（ヴリッティ）が止滅された時、純粋な意識が現れるということです。単なる抑圧ではなく、真我が顕現する静寂の境地であり、全てのヨーガ実践はこの目的に向かっています。"
  },
  {
    chapter: 1,
    verse: 3,
    text: "tadā draṣṭuḥ svarūpe 'vasthānam",
    importance: 9,
  ...
  },
  {
    ...
    insights_jp: "心の作用が止まっていない時、見る者はヴリッティと同一視され、純粋意識としての本性を見失います。この誤った同一化こそが無明（アヴィディヤー）の根本であり、束縛の原因です。自己と心の区別を見極める認識が不可欠となります。"
  },
  {
    chapter: 1,
    verse: 5,
    text: "vṛttayaḥ pañcatayyaḥ kliṣṭākliṣṭāḥ",
    importance: 7,
  ...
  },
  {
    chapter: 1,
    verse: 6,
    text: "pramāṇa viparyaya vikalpa nidrā smṛtayaḥ",
    importance: 7,
    translation: "They are right knowledge, wrong knowledge, verbal delusion, sleep, and memory.",
    translation_jp: "（それらは）正しい認識、誤った認識、言葉による幻想、睡眠、記憶である。",
    ...
    insights_jp: "五つのヴリッティ、すなわちプラマーナ（正知）、ヴィパリヤヤ（誤知）、ヴィカルパ（概念）、ニドラー（睡眠）、スムリティ（記憶）は、心の全活動を網羅します。これらを見極めることが、心を制御し止滅へと向かう第一歩です。"
  },
  {
    chapter: 1,
    verse: 7,
    text: "pratyakṣānumānāgamāḥ pramāṇāni",
    importance: 7,
  ...
  },
  {
    ...
    insights_jp: "ヴィパリヤヤは、実在しないものを実在と誤認する誤知です。このような錯誤はヨーガの道を妨げ、無明（アヴィディヤー）を強化し、苦しみを増長させます。識別智（ヴィヴェーカ）を養うことが、誤知を超える鍵となります。"
  },
  {
    chapter: 1,
    verse: 9,
    text: "śabdajñānānupātī vastuśūnyo vikalpaḥ",
    importance: 6,
    translation: "Verbal delusion follows from words having no corresponding reality.",
    translation_jp: "言葉による幻想とは、実体を伴わない言葉の知識から生じるものである。",
    ...
    insights_jp: "ヴィカルパは、言葉が現実の裏付けを持たず、言語的な構築や空想が独り歩きする時に生じる心の作用です。ヨーガ行者は、単なる言語知を超えて直観的体験に至るべきであり、言葉は真理を示すと同時に覆い隠すこともあると知る必要があります。"
  },
  {
    chapter: 1,
    verse: 10,
    text: "abhāvapratyayālambanā vṛttirnidrā",
    importance: 6,
    translation: "Sleep is that modification of the mind which is based on the absence of any content.",
    translation_jp: "睡眠とは、いかなる内容も欠如しているという認識を対象とする心の作用である。",
  ...
  },
  {
    chapter: 1,
    verse: 11,
    text: "anubhūtaviṣayāsaṁpramoṣaḥ smṛtiḥ",
    importance: 7,
    translation: "Memory is the retention of experienced objects.",
    translation_jp: "記憶とは、経験した対象を失わずに保持することである。",
  ...
  },
  {
    chapter: 1,
    verse: 12,
    text: "abhyāsavairāgyābhyāṁ tannirodhaḥ",
    importance: 9,
    ...
    insights_jp: "アビャーサ（不断の修習）とヴァイラーギャ（離欲）の二つが、ヨーガの両輪です。修習は心を安定させ、離欲は執着を溶かします。両者が揃って初めて真の止滅が可能となり、いずれかを欠けば偏りが生じます。"
  },
  {
    chapter: 1,
    verse: 13,
    text: "tatra sthitau yatno 'bhyāsaḥ",
    importance: 8,
    translation: "Practice is the effort to attain steadiness in that state [of nirodha].",
    translation_jp: "その状態（心の作用の止滅）における不動性を得るための努力が修習である。",
  ...
  },
  {
    chapter: 1,
    verse: 14,
    text: "sa tu dīrghakālanairantaryasatkārāsevito dṛḍhabhūmiḥ",
    importance: 8,
    translation: "It becomes firmly grounded when practiced for a long time, without interruption, and with devotion.",
    translation_jp: "それは、長期間、中断なく、敬意をもって実践されたときに、確固たる基盤となる。",
    insights: "Patañjali insists that only practice performed over a long duration, without interruption, and with deep reverence, becomes firmly rooted. Such practice transforms the mind at its deepest layers, making samādhi possible.",
    insights_jp: "パタンジャリは、長期間にわたり、中断なく、敬虔な心をもって行われる修習のみが、確固たる基盤となると説きます。そのような修習は心の最も深い層に変容をもたらし、三昧への道を開きます。"
  },
  {
    chapter: 1,
    verse: 15,
    text: "dṛṣṭānuśravikaviṣayavitṛṣṇasya vaśīkārasaṁjñā vairāgyam",
    importance: 9,
    ...
    translation_jp: "見たり聞いたりした対象への渇望から自由になった者の、制御自在の意識が離欲である。",
  ...
  },
  {
    chapter: 1,
    verse: 16,
    text: "tatparaṁ puruṣakhyāterguṇavaitṛṣṇyam",
    importance: 9,
    ...
    translation_jp: "プルシャ（真我）の明確な知識により、グナ（自然の三つの構成要素）に対する渇望さえもなくなることが、最高の離欲である。",
    ...
    insights_jp: "ヨーギーがプルシャ（純粋意識）を真に認識した時、自然（プラクリティ）の三グナに対する最も微細な渇望さえも消滅します。これが最高の離欲であり、解脱への直道です。"
  },
  {
    chapter: 1,
    verse: 17,
    text: "vitarkavicārānandāsmitārūpānugamāt samprajñātaḥ",
    importance: 8,
  ...
  },
  {
    chapter: 1,
    verse: 18,
    text: "virāmapratyayābhyāsapūrvaḥ saṁskāraśeṣo 'nyaḥ",
    importance: 8,
    ...
    translation_jp: "（心の作用の）停止の認識を修習することによって先行され、潜在印象のみが残る状態が、もう一方（無想三昧、アサンプラジュニャータ・サマーディ）である。",
    ...
    insights_jp: "アサンプラジュニャータ・サマーディ（無想三昧）は、微細な対象性すら超越し、心の働きが完全に停止し、潜在印象（サンスカーラ）のみが残る状態です。これは、さらに種子なき三昧（ニルビージャ・サマーディ）への入り口となります。"
  },
  {
    chapter: 1,
    verse: 19,
    text: "bhavapratyayo videhaprakṛtilayānām",
    importance: 7,
    translation: "For those who are videhas (disembodied) and prakṛtilayas (merged in prakṛti), it is caused by birth.",
    translation_jp: "ヴィデーハ（肉体を持たない者）やプラクリティラヤ（自然に融合した者）にとっては、（このサマーディは）生まれながらにして得られる。",
    insights: "Certain beings, such as the videhas and prakṛtilayas, attain high states of absorption not through conscious effort but as a result of their existential condition. Yet, without discriminative knowledge of Puruṣa, even these states do not yield final liberation.",
    insights_jp: "ヴィデーハ（身体を離れた存在）やプラクリティラヤ（自然に溶解した存在）は、努力によらず生得的に高次の吸収状態を得ます。しかし、プルシャ（真我）の識別智がなければ、これらの状態も最終解脱には至りません。"
  },
  {
    chapter: 1,
    verse: 20,
    text: "śraddhāvīryasmṛtisamādhiprajñāpūrvaka itareṣām",
    importance: 9,
    ...
    insights_jp: "多くの修行者にとって、三昧への道は、信（シュラッダー）、精進（ヴィーリヤ）、憶念（スムリティ）、三昧（サマーディ）、智慧（プラジュニャー）という五つの資質を順に積み重ねることで開かれます。各資質が次の段階を支え、悟りの条件を熟成させます。"
  },
  {
    chapter: 1,
    verse: 21,
    text: "tīvrasaṁvegānāmāsannaḥ",
    importance: 8,
    translation: "Success is nearest to those whose efforts are intense.",
    translation_jp: "強烈な意欲を持つ者には（サマーディは）近い。",
    insights: "The degree of urgency and intensity (saṁvega) in practice determines the nearness of realization. Those who approach yoga with burning aspiration and wholehearted commitment progress most swiftly.",
    insights_jp: "修行への強烈な意欲（サンヴェーガ）と切実さの度合いが、悟りの近さを決定します。燃えるような志と全身全霊の献身でヨーガに臨む者ほど、最も速やかに進展します。"
  },
  {
    chapter: 1,
    verse: 22,
    text: "mṛdumadhyādhimātratvāttato'pi viśeṣaḥ",
    importance: 7,
    translation: "Because of the mild, medium, or intense nature of the efforts, there are further distinctions.",
    translation_jp: "努力が穏やかか、中間か、強烈かによって、さらに差異が生じる。",
    insights: "Even among the earnest, distinctions arise according to the mildness, mediocrity, or intensity of their practice. The yogin must honestly assess and continually refine the quality of their effort.",
    insights_jp: "たとえ熱心な修行者の間でも、その努力が穏やかなのか、中程度なのか、強烈なのかによって、進展に違いが生じます。自らの努力の質を正直に見極め、絶えず洗練していくことが肝要です。"
  },
  {
    chapter: 1,
    verse: 23,
    text: "īśvarapraṇidhānādvā",
    importance: 9,
  ...
  },
  {
    chapter: 1,
    verse: 24,
    text: "kleśakarmavipākāśayairaparāmṛṣṭaḥ puruṣaviśeṣa īśvaraḥ",
    importance: 8,
    translation: "Īśvara is a special Puruṣa, untouched by afflictions, actions, their results, or latent impressions.",
    translation_jp: "イーシュヴァラとは、苦悩（クレーシャ）、行為（カルマ）、行為の結果（ヴィパーカ）、潜在印象（アーシャヤ）に触れられない特別なプルシャ（純粋意識）である。",
    insights: "Īśvara is the archetypal Self, eternally free from affliction (kleśa), karma, its fruits, and latent impressions. Meditating on such a flawless consciousness provides an unerring support for the aspirant’s own liberation.",
    insights_jp: "イーシュヴァラは、苦悩（クレーシャ）、業（カルマ）、その果報（ヴィパーカ）、潜在印象（アーシャヤ）に一切触れられない、究極に純粋なプルシャ（自己）です。このような無垢なる意識を観想することが、修行者の解脱を確実に導く支えとなります。"
  },
  {
    chapter: 1,
    verse: 25,
    text: "tatra niratiśayaṁ sarvajñabījam",
    importance: 8,
    translation: "In Him, the seed of omniscience is unsurpassed.",
    translation_jp: "彼において、全知の種子は無上である。",
    ...
    insights_jp: "イーシュヴァラの内には、無上で尽きることのない全知の種子（サルヴァジュニャトヴァ）が宿っています。この全知性を観想することで、ヨーギーは神聖な導きへの信頼を深めます。"
  },
  {
    chapter: 1,
    verse: 26,
    text: "sa eṣa pūrveṣāmapi guruḥ kālenānavacchedāt",
    importance: 8,
    translation: "He is the teacher of even the ancient teachers, being not limited by time.",
    translation_jp: "彼は、時間によって限定されないため、古代の師たちの師でもある。",
    ...
    insights_jp: "イーシュヴァラは、時を超越した根源的な師（グル）であり、すべての霊的伝承の源泉です。真の教えは、究極的にはこの永遠の泉から流れ出ます。"
  },
  {
    chapter: 1,
    verse: 27,
    text: "tasya vācakaḥ praṇavaḥ",
    importance: 9,
    translation: "His designator is Praṇava (the syllable Om).",
    translation_jp: "彼の表示語はプラナヴァ（オーム）である。",
    ...
    insights_jp: "聖音オーム（プラナヴァ）は、イーシュヴァラを言語で示す表示語（ヴァーチャカ）です。オームの誦唱と観想は、有限な心と無限なる神性を結びつけ、ヨーギーに神聖への道を開きます。"
  },
  {
    chapter: 1,
    verse: 28,
    text: "tajjapastadarthabhāvanam",
    importance: 9,
    translation: "Its repetition and meditation on its meaning should be done.",
    translation_jp: "その（オームの）読誦と、その意味の瞑想（を行うべきである）。",
    ...
    insights_jp: "オームの誦唱（ジャパ）と意味の深い観想によって、心はその源と調和します。この方法は心を浄化し、霊的成長を加速させます。"
  },
  {
    chapter: 1,
    verse: 29,
    text: "tataḥ pratyakcetanādhigamo'pyantarāyābhāvaśca",
    importance: 9,
    translation: "From that, comes the realization of the inner consciousness and the removal of obstacles.",
    translation_jp: "それから、内なる意識の覚醒と障害の除去が起こる。",
    ...
    insights_jp: "オームの修習によって、ヨーギーは内なる意識（プラティヤク・チェタナ）を覚醒させ、進歩を妨げる障害（アンタラーヤ）を除去します。これは実践的かつ神秘的な過程であり、音・心・霊が統合されます。"
  },
  {
    chapter: 1,
    verse: 30,
    text: "vyādhistyānasaṁśayapramādālasyāviratibhrāntidarśanālabdhabhūmikatvānavasthitatvāni cittavikṣepāste'ntarāyāḥ",
    importance: 8,
    ...
    translation_jp: "病気、無気力、疑い、怠慢、ものぐさ、禁欲の欠如、誤った見解、安定した境地に至れないこと、不安定さ、これらは心の混乱であり、障害である。",
    ...
    insights_jp: "パタンジャリは、修行を妨げる障害（アンタラーヤ）として、病気、無気力、疑念、不注意、怠惰、感覚的追求、誤解、進展の欠如、不安定を挙げます。これらを障害として認識することが、超克への第一歩です。"
  },
  {
    chapter: 1,
    verse: 31,
    text: "duḥkhadaurmanasyāṅgamejayatvaśvāsapraśvāsā vikṣepasahabhuvaḥ",
    importance: 7,
    translation: "Sorrow, despair, unsteadiness of the body, and irregular breathing accompany these distractions.",
    translation_jp: "苦痛、憂鬱、身体の震え、不規則な呼吸は、これらの混乱に伴って現れる。",
    ...
    insights_jp: "これらの障害は、苦悩、憂鬱、身体の不安、呼吸の乱れとして現れます。ヨーギーは原因と症状の両面を見極め、適切に対処する知恵を養う必要があります。"
  },
  {
    chapter: 1,
    verse: 32,
    text: "tatpratiṣedhārthamekatattvābhyāsaḥ",
    importance: 8,
    translation: "For their prevention, the practice of concentration on a single principle should be made.",
    translation_jp: "それらを防ぐために、一つの対象への集中を修習すべきである。",
    ...
    insights_jp: "心の混乱を防ぐには、一つの対象や原理への集中修習（エカタットヴァアビャーサ）が最良の対策です。この集中によって、散乱した心の力が集められ、明晰さと平静が回復します。"
  },
  {
    chapter: 1,
    verse: 33,
    text: "maitrīkaruṇāmuditopekṣāṇāṁ sukhaduḥkhapuṇyāpuṇyaviṣayāṇāṁ bhāvanātaścittaprasādanam",
    importance: 9,
    ...
    translation_jp: "幸福な者への友愛、苦しむ者への慈悲、徳のある者への喜び、不徳な者への平静さを培うことによって、心は清澄になる。",
    ...
    insights_jp: "幸福な者へは友愛（マイトリー）、苦しむ者へは慈悲（カルナー）、徳ある者へは喜悦（ムディター）、不徳な者へは平静（ウペクシャー）を育むことで、心が清澄になります。この伝統的教えは、内外の葛藤を解消し、ヨーギーの心を世界と調和させます。"
  },
  {
    chapter: 1,
    verse: 34,
    text: "pracchardanavidhāraṇābhyāṁ vā prāṇasya",
    importance: 7,
    translation: "Or, serenity is attained by the expulsion and retention of breath.",
    translation_jp: "あるいは、プラーナ（生命エネルギー）の呼出と保持によって（心の平静は得られる）。",
    ...
    insights_jp: "プラーナーヤーマ（呼吸法）は、心の静寂を得るための直接的な手段として示されます。呼吸を通じて生命エネルギーを巧みに調整することで、身体と心が調和し、深い瞑想への準備が整います。"
  },
  {
    chapter: 1,
    verse: 35,
    text: "viṣayavatī vā pravṛttirutpannā manasaḥ sthitinibandhanī",
    importance: 7,
    translation: "Or, the development of higher sense perception relating to objects can cause mental steadiness.",
    translation_jp: "あるいは、対象に関する超感覚的な認識が生じると、心は安定する。",
  ...
  },
  {
    ...
    insights_jp: "完全に欲望を離れた心（ヴィータラーガ）を観想することで、修行者自身も同様の離欲を育てることができます。この心の模範は、渇望の消滅と平静の養成を支えます。"
  },
  {
    chapter: 1,
    verse: 38,
    text: "svapnanidrājñānālambanaṁ vā",
    importance: 7,
  ...
  },
  {
    chapter: 1,
    verse: 40,
    text: "paramāṇuparamamahattvānto'sya vaśīkāraḥ",
    importance: 7,
  ...
  },
  {
    chapter: 1,
    verse: 41,
    text: "kṣīṇavṛtterabhijātasyeva maṇergrahītṛgrahaṇagrāhyeṣu tatsthatadañjanatā samāpattiḥ",
    importance: 8,
    ...
    translation_jp: "心の作用が弱まったとき、清浄な水晶のように、把握するもの、把握すること、把握されるもの、いずれに置かれてもそのものの色を帯びる状態をサマーパッティ（等引）という。",
    ...
    insights_jp: "ヴリッティが弱まると、心は清浄な水晶のようになり、対象・認識作用・認識者のいずれにも完全に染まります。これがサマーパッティ（等引）であり、主体と客体の区別が消える境地です。"
  },
  {
    chapter: 1,
    verse: 42,
    text: "tatra śabdārthajñānavikalpaiḥ saṅkīrṇā savitarkā samāpattiḥ",
    importance: 7,
  ...
  },
  {
    chapter: 1,
    verse: 43,
    text: "smṛtipariśuddhau svarūpaśūnyevārthamātranirbhāsā nirvitarkā",
    importance: 7,
  ...
  },
  {
    chapter: 1,
    verse: 44,
    text: "etayaiva savicārā nirvicārā ca sūkṣmaviṣayā vyākhyātā",
    importance: 7,
    translation: "By this, savicārā, nirvicārā, and subtler states of samāpatti are also explained.",
    translation_jp: "これによって、有伺三昧（サヴィチャーラー）、無伺三昧（ニルヴィチャーラー）、そしてさらに微細な対象を持つサマーパッティも説明される。",
  ...
  },
  {
    chapter: 1,
    verse: 45,
    text: "sūkṣmaviṣayatvaṁ cāliṅgaparyavasānam",
    importance: 7,
    translation: "The province of subtle objects extends up to the unmanifest (Prakṛti).",
    translation_jp: "微細な対象の領域は、無相（プラクリティ、根本原質）にまで及ぶ。",
    insights: "The field of subtle objects (sūkṣmaviṣaya) extends all the way to the unmanifest (aliṅga), the primordial root of nature. Even the subtlest object must ultimately be transcended for liberation.",
    insights_jp: "微細な対象（スークシュマヴィシャヤ）の領域は、無相（アリンガ）、すなわち自然の根本原質にまで及びます。最も微細な対象さえも、最終的には超越されねば解脱には至りません。"
  },
  {
    chapter: 1,
    verse: 46,
    text: "tā eva sabījaḥ samādhiḥ",
    importance: 8,
    translation: "These (samāpattis) are samādhi with seed.",
    translation_jp: "これら（のサマーパッティ）は種子のある三昧（サビージャ・サマーディ）である。",
  ...
  },
  {
    ...
    insights_jp: "ニルヴィチャーラー・サマーパッティ（無伺三昧）に熟達すると、内なる自己の光明（アディヤートマ・プラサーダ）が現れます。心が極限まで精緻化され、純粋意識の光が遮られることなく輝きます。"
  },
  {
    chapter: 1,
    verse: 48,
    text: "ṛtaṁbharā tatra prajñā",
    importance: 9,
    translation: "In that state, wisdom is truth-bearing (ṛtaṁbharā).",
    translation_jp: "そこにおいて、智慧は真理を担う（リタンバラー）。",
  ...
  },
  {
    chapter: 1,
    verse: 49,
    text: "śrutānumānaprajñābhyāmanyaviṣayā viśeṣārthatvāt",
    importance: 8,
  ...
  },
  {
    chapter: 1,
    verse: 50,
    text: "tajjaḥ saṁskāro'nyasaṁskārapratibandhī",
    importance: 8,
    ...
    insights_jp: "真理を担う智慧によって生じた潜在印象（サンスカーラ）は、他のすべてのサンスカーラを打ち消し、やがて中和します。このようにして、束縛の種子は徐々に尽きていきます。"
  },
  {
    chapter: 1,
    verse: 51,
    text: "tasyāpi nirodhe sarvanirodhānnirbījaḥ samādhiḥ",
    importance: 10,
    ...
    insights_jp: "真理を担う智慧のサンスカーラさえも止滅したとき、すべてのヴリッティとサンスカーラが完全に超克されます。これが種なし三昧（ニルビージャ・サマーディ）であり、ヨーガの究極完成、純粋自己の輝きそのものです。"
  }
];

// Example of how you might use it (optional, for context)
// console.log(yoga_sutras_samadhi_pada[50].translation); // Should output the English translation of Sutra 1.51
